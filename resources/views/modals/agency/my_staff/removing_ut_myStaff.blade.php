<div id="removing_ut_myStaff" class="modal is_hidden is_visually_hidden">
	 ...
	 <div class="modal_content modal_myStaff">
		...
		<div class="modal_body">
			...
			<div class="label_update_modal">
				...
				<label class="label_big_bold namemyStaff" data-myStaffId="" data-staffId=""></label>
			</div>
		</div>
		<div class="footer_update_modal footer_modal_finish">
		   <button class="close_modal button_choose delete_staff" data-deleteMyStaff="{{ route('deleteAgencyStaff') }}"> {!! trans('modals_my_staff.Delete') !!}
			</button>
	    </div>
	 </div>
