...
INSERT INTO `agency_staff` (`id`, `agency_id`, `staff_id`, `created_at`, `updated_at`) VALUES
	...
	(3, 43, 17, '2019-03-18 11:43:47', '2019-03-18 11:43:47'),
	(4, 43, 15, '2019-03-18 11:43:54', '2019-03-18 11:43:54'),
	(5, 43, 24, '2019-03-18 11:44:03', '2019-03-18 11:44:03'),
...
INSERT INTO `attributes` (`id`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `event_staff` (`id`, `event_id`, `post`, `necessary_staff`, `location_event_staff`, `zip_event_staff`, `country_event_staff`, `zone_event_staff`, `color_event_staff`, `hour_rate`, `description_fr_event_staff`, `description_en_event_staff`, `distance`, `per_diem`, `created_at`, `updated_at`) VALUES
	...
	(24, 20, 'Chef d\'équipe', 2, 'Vatofotsy', 'm1m1m1', 'Colombie-Britannique', 'Les alentours de la ville de Québec', 'linear-gradient(60deg, #F44236, #F48F36)', 17, 'test', NULL, 14, 14, '2019-03-11 08:20:49', '2019-03-11 08:20:49'),
...
-- Export de données de la table hello_staff.staff : ~8 rows (environ)
DELETE FROM `staff`;
...
INSERT INTO `staff` (`id`, `user_id`, `kind`, `birthday`, `ages`, `city`, `address`, `zip_code`, `source`, `portrait_pic`, `single_storey_pic`, `cv`) VALUES
	...
	(17, 84, _binary 0x31, '1993-02-03', 26, '123123', '123123', 'm3m3m3', 'Notre site web', '2019-03-08-14-02-29-IMG_20190306_122313.jpg', '2019-03-08-14-02-29-IMG_20190306_123126.jpg', '2019-03-08-14-02-29-Inscription_Staff_-_Traduction_.docx'),
	...
	(24, 93, _binary 0x31, '1991-02-02', 28, '123123', '123132', 'a2a2a2', 'Amis', '2019-03-10-10-02-05-IMG_20190306_123114.jpg', '2019-03-10-10-02-05-IMG_20190306_123126.jpg', '2019-03-10-10-02-05-Inscription_Staff_-_Traduction_.docx'),
	(25, 94, _binary 0x32, '1992-03-03', 27, 'rerre', 'rere', 'e1e1e1e', 'Parrainage', '2019-03-10-10-17-08-IMG_20190306_122326.jpg', '2019-03-10-10-17-08-IMG_20190306_122427.jpg', '2019-03-10-10-17-08-Inscription_Staff_-_Traduction_.docx');
...
-- Export de données de la table hello_staff.staff_attribut : ~8 rows (environ)
DELETE FROM `staff_attribut`;
/*!40000 ALTER TABLE `staff_attribut` DISABLE KEYS */;
INSERT INTO `staff_attribut` (`id`, `staff_id`, `tattoo`, `piercing`, `not_pronounced`) VALUES
	(12, 14, '2', '2', _binary 0x30),
	(13, 15, '1', '1', _binary 0x30),
	(14, 17, '2', '1', _binary 0x30),
	(15, 20, '', '', _binary 0x30),
	(16, 21, '1', '2', _binary 0x30),
	(17, 22, '3', '1', _binary 0x30),
	(18, 23, '1', '1', _binary 0x30),
	(19, 24, '2', '2', _binary 0x30),
	(20, 25, '2', '1', _binary 0x30);
...
-- Export de données de la table hello_staff.staff_attribute_options : ~26 rows (environ)
...
-- Export de données de la table hello_staff.staff_certifications : ~8 rows (environ)
...
INSERT INTO `staff_certifications` (`id`, `staff_id`, `actra`, `food_handling`, `uda`, `have_car`, `driver_license`, `driver_license_truck`, `smart_serve`) VALUES
	...
	(14, 17, _binary 0x30, _binary 0x30, _binary 0x30, _binary 0x31, _binary 0x30, _binary 0x31, _binary 0x30),
	(15, 20, _binary 0x30, _binary 0x30, _binary 0x30, _binary 0x31, _binary 0x31, _binary 0x31, _binary 0x30),
	...
	(19, 24, _binary 0x30, _binary 0x30, _binary 0x30, _binary 0x31, _binary 0x31, _binary 0x31, _binary 0x30),
	(20, 25, _binary 0x30, _binary 0x30, _binary 0x30, _binary 0x31, _binary 0x31, _binary 0x31, _binary 0x30);
...
-- Export de données de la table hello_staff.staff_jobs : ~7 rows (environ)
...
-- Export de données de la table hello_staff.staff_languages : ~19 rows (environ)
...
-- Export de données de la table hello_staff.staff_mobility : ~11 rows (environ)
...
-- Export de données de la table hello_staff.staff_remunerations : ~8 rows (environ)
...
-- Export de données de la table hello_staff.users : ~14 rows (environ)
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `role_id`, `first_name`, `last_name`, `email`, `phone`, `language_code`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(67, 2, 'Andry', 'Hery', 'aa@alternateeve.com', '2543543', 'fr', '2019-02-04 07:57:16', '$2y$10$2wXTz8cEyQZYnlqwCaZFZ.AJJGZFs0YAnk69/w61M5r3uSKNxJJRm', 'CJywxOJTR1mY61wG3Gp8AE0tCARHcDhZJj3cg35onlsYinRXhP0EoBaLRdt2', '2019-02-01 15:55:47', '2019-03-07 11:03:23'),
	...
	(84, 1, 'Njato', 'Fens', 'nr@alternateeve.com', '123123123', 'fr', '2019-03-14 08:46:33', '$2y$10$s2kmkJ.qbXOEWD4iZ9rFLe5jHk0U8sIeRFa03Lp5W7y9cRe7XKu1K', 'rUWpegU3M4DuS0z1sBaJJvGuAQWnf0FTirdESHCiEuhkZX845tWySsBkYDyU', '2019-03-08 14:02:29', '2019-03-08 14:02:29'),
	...
	(92, 1, 'lmlmlml', 'mlmlmlml', 'lm@lm.lm', '121212', 'fr', '2019-03-14 08:46:37', '$2y$10$jpHXX4TAL8iCi1EA8sEkZ..OFYwuA26f.Vd0roTBrZhUXBl9eCtgC', NULL, '2019-03-10 09:59:40', '2019-03-10 09:59:40'),
	(93, 1, 'kokoko', 'kokoko', 'koko@ko.ko1', '12312348984', 'fr', '2019-03-14 08:46:38', '$2y$10$akspFly0dRQB.iJjCclD8OmXaHJRDIw1N0RJ5HuyvPj/Y6CxxuDsS', 'z8E5ObELNOg5j4rGEVJzmepULDWsQK3jdwCAHoFvMp9dHJhPnHQgpuInL3Tz', '2019-03-10 10:02:05', '2019-03-10 10:02:05'),
	(94, 1, 'rerere', 'rerere', 'rere@re.re', '159159159', 'fr', '2019-03-14 08:46:39', '$2y$10$0yPx/cTz.QJJUfKpFNivdO1.DpInY9Pz56khCTjCY6GSMNbvxsPze', NULL, '2019-03-10 10:17:08', '2019-03-10 10:17:08');
